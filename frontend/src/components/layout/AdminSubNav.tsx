...
const items = [
  ...
  { to: '/admin/tables', label: 'Tables', icon: LayoutGrid, group: 'Setup', roles: ['owner', 'manager'] },
  { to: '/admin/payment-methods', label: 'Payments', icon: Store, group: 'Setup', roles: ['owner', 'manager'] },
];
