...
export default function BlogDetail(){
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-sm text-zinc-600 mt-4 leading-relaxed">All our pizzas use 100% real mozzarella and all prices include tax. Visit our outlets in Vasai West, Mira Road East, and Bhayandar West — or order online for free delivery 11AM–4AM.</p>
