...
func main() {
	...
	adminGroup.Use(admin.TenantMiddleware())
	{
		...
		adminGroup.GET("/analytics/cohort", adminHandler.GetAnalyticsCohort)
		adminGroup.GET("/analytics/funnel", adminHandler.GetAnalyticsFunnel)
		adminGroup.GET("/analytics/breakdown", adminHandler.GetAnalyticsBreakdown)
		...
		// PR #2 foundation: addon groups/items (catalog), tables, payments, customer fields
		adminGroup.GET("/addon-groups", adminHandler.RequirePermission("pos.read"), adminHandler.ListAddonGroups)
		adminGroup.POST("/addon-groups", adminHandler.RequireRole("owner", "manager"), adminHandler.CreateAddonGroup)
		adminGroup.PUT("/addon-groups/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.UpdateAddonGroup)
		adminGroup.DELETE("/addon-groups/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.DeleteAddonGroup)
		adminGroup.GET("/addon-groups/:id/items", adminHandler.RequirePermission("pos.read"), adminHandler.ListAddonItems)
		adminGroup.POST("/addon-groups/:id/items", adminHandler.RequireRole("owner", "manager"), adminHandler.CreateAddonItem)
		adminGroup.PUT("/addon-items/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.UpdateAddonItem)
		adminGroup.DELETE("/addon-items/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.DeleteAddonItem)
		adminGroup.GET("/tables", adminHandler.RequirePermission("pos.read"), adminHandler.ListTablesAdmin)
		adminGroup.POST("/tables", adminHandler.RequireRole("owner", "manager"), adminHandler.CreateTableAdmin)
		adminGroup.PUT("/tables/reorder", adminHandler.RequireRole("owner", "manager"), adminHandler.ReorderTables)
		adminGroup.PUT("/tables/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.UpdateTableAdmin)
		adminGroup.DELETE("/tables/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.DeleteTableAdmin)
		adminGroup.GET("/payment-methods", adminHandler.RequirePermission("pos.read"), adminHandler.ListPaymentMethods)
		adminGroup.POST("/payment-methods", adminHandler.RequireRole("owner", "manager"), adminHandler.CreatePaymentMethod)
		adminGroup.PUT("/payment-methods/reorder", adminHandler.RequireRole("owner", "manager"), adminHandler.ReorderPaymentMethods)
		adminGroup.PUT("/payment-methods/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.UpdatePaymentMethod)
		adminGroup.DELETE("/payment-methods/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.DeletePaymentMethod)
		adminGroup.GET("/customer-fields", adminHandler.RequirePermission("pos.read"), adminHandler.ListCustomerFields)
		adminGroup.POST("/customer-fields", adminHandler.RequireRole("owner", "manager"), adminHandler.UpsertCustomerField)
		adminGroup.PUT("/customer-fields/reorder", adminHandler.RequireRole("owner", "manager"), adminHandler.ReorderCustomerFields)
		adminGroup.PUT("/customer-fields/:id", adminHandler.RequireRole("owner", "manager"), adminHandler.UpdateCustomerField)
		// compat aliases for PR #2 spec (pos prefix)
		adminGroup.GET("/pos/customer-fields", adminHandler.RequirePermission("pos.read"), adminHandler.ListCustomerFields)
		adminGroup.PUT("/pos/customer-fields", adminHandler.RequireRole("owner", "manager"), adminHandler.UpsertCustomerField)
	}
