...
func RecordPayment(orderID, restaurantID, outletID int, method string,
	...
	receivedBy int) (int, error) {

	var paymentID int
	err := database.DB.QueryRow(`
		INSERT INTO order_payments (order_id, restaurant_id, outlet_id,
			method, amount, tendered, change_due, reference, received_by, created_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, CURRENT_TIMESTAMP)
		RETURNING id`,
		orderID, restaurantID, outletID, method, amountPaise, tenderedPaise, 0, reference, receivedBy).Scan(&paymentID)
	if err != nil {
		return 0, err
	}
